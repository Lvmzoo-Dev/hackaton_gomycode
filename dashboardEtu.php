        ...
        <div class="div-left">
            ...
            <nav>
                <ul>
                    ...
                    <li><img src="images/ecrire.png" class="icon" alt=""> <a href="#" onclick="openForm()">Eceerire au Prof</a></li>
                    <li><img src="images/deconnexion.png" class="icon" alt=""> <a href="#">Déconnexion</a></li>
                </ul>
            </nav>
